    ...
    <div class="app-sidebar colored">
        <div class="sidebar-header">
            <a class="header-brand" href="home.php">
                <div class="logo-img">
                    <img src="dist/img/icone.png" class="header-brand-img" alt="lavalite" style="height: 30px; width: 30px;">
                </div>
            ...
            <div class="nav-container">
                <nav id="main-menu-navigation" class="navigation-main">
                    <div class="nav-lavel text-center p-3">
                        <div class="mb-2">
                            <img src="dist/img/usuarios/<?php echo "1.jpg"; ?>" class="header-brand-img rounded-circle" alt="lavalite" style="height: 80px; width: 80px;">
                        </div>
                        <div class="">
                    ...
                    <div class="nav-item has-sub">
                        <a href="javascript:void(0)"><i class="ik ik-users"></i><span>Usuários</span></a>
                    ...
                    <div class="nav-item has-sub">
                        <a href="javascript:void(0)"><i class="ik ik-package"></i><span>Produtos</span></a>
                        <div class="submenu-content">
