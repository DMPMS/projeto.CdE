...
if (!logado()) {
    ...
    $sqlAdministradores = "SELECT * FROM usuarios_usuarios WHERE tipo IN('Administrador') AND ativo = 0";
...
?>
    ...
    <body>
            ...
            <div class="page-wrap">
                ...
                <div class="main-content">
                    <div class="container-fluid">
                        <!--Page-Header-->
                        <?php pageHeader(
                            [6, [["../../home.php", "home", "blue"], ["usuarios.home.php", "users", "blue"]], ["user-check", "blue"]],
                            [6, [["../../home.php", "Página Inicial"], ["usuarios.home.php", "Usuários"]], "Administradores"]
                        ); ?>
                        <!--/Page-Header-->
                        <div class="card shadow-lg">
                            <div class="card-body">
                                <div class="dt-responsive">
                                    <?php dataTable("administradores", "Administradores", ["Nome", "E-mail", "Compras", "Dinheiro em Vendas", "Ações"], $pdo, $sqlAdministradores) ?>
                                </div>
                            </div>
                        </div>
                        <!--Modais de Dados-->
                        <?php foreach ($pdo->query($sqlAdministradores) as $row) {
                        ...
                        <?php if (tipoUsuario($_SESSION['id']) == "Administrador Geral") { ?>
                            <!--Modais de Excluir-->
                            <?php foreach ($pdo->query($sqlAdministradores) as $row) {
                                modalExcluirAdministrador($row, ['../../dist/img/usuarios/' . $row['id'] . '.png']);
                            } ?>
                            <!--/Modais de Excluir-->
                        <?php } ?>
        ...
        <!--Script da Datatable-->
        <?php scriptDataTablePadrao("administradores"); ?>
        <?php modalAdministradorCadastrado(); ?>
    </body>
