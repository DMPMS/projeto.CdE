                                                ...
                                                <?php foreach ($pdo->query($sql) as $row) { ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <a title="Clientes de <?php echo $row['nome']; ?>" href="list_administrador_cliente.php?id=<?php echo $row['id']; ?>" class="btn btn-icon btn-primary mr-1"><i class="ik ik-list"></i></a>
