...
if (isset($_SESSION['id']) == '') {
    ...
    <html class="no-js" lang="en">
        <head>
            ...
            <?php if (isset($_SESSION['indisponivel'])) { ?>
            ...
            <?php if (isset($_SESSION['Bem-vindo'])) { ?>
                <!--Notificação Bem vindo-->
                <script>
                    window.onload = function () {
                        $.toast({
                            text: 'Bem-vindo(a) novamente, <b><?php echo $_SESSION['nome'];?></b>.',
                            icon: 'info',
                            hideAfter: 5000,
                            loader: false,
                            position: 'top-right'
