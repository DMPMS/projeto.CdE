                ...
                <nav id="main-menu-navigation" class="navigation-main">
                    ...
                    <div class="nav-item has-sub">
                        ...
                        <div class="submenu-content">
                            <!-- style="display: block;"-->
                            <a href="../usuarios/home_Usuarios.php" class="menu-item">Início</a>
                            <a href="../usuarios/cad_usuario.php" class="menu-item">Novo</a>
                            <a href="../usuarios/list_cliente.php" class="menu-item">Clientes</a>
                            <a href="../usuarios/list_administrador.php" class="menu-item">Administradores</a>
                        </div>
                    </div>
                    <div class="nav-item has-sub">
                        ...
                        <div class="submenu-content">
                            <a href="../produtos/home_produtos.php" class="menu-item">Início</a>
                            <a href="../produtos/cad_produto.php" class="menu-item">Novo Produto</a>
                            <a href="../produtos/list_produto.php" class="menu-item">Produtos</a>
                            <a href="../produtos/cad_tipo.php" class="menu-item">Novo Tipo</a>
                            <a href="../produtos/list_tipo.php" class="menu-item">Tipos</a>
                        </div>
                    </div>
                    <div class="nav-item has-sub">
                        <a href="javascript:void(0)"><i class="ik ik-shopping-cart"></i><span>Vendas</span></a>
                        <div class="submenu-content">
                        <a href="../vendas/home_vendas.php" class="menu-item">Início</a>
                            <a href="../vendas/cad_venda.php" class="menu-item">Nova Venda</a>
                            <a href="../vendas/list_venda.php" class="menu-item">Vendas</a>
                            <a href="../vendas/list_venda_canceladas.php" class="menu-item">Vendas Canceladas</a>
                        </div>
                    </div>
                    <div class="nav-item has-sub">
