...
if (isset($_SESSION['id']) == '') {
    ...
    if (!isset($_GET['id']) || $_GET['id'] == '' || TipoUsuario($_GET['id']) != "Administrador" || UsuarioExiste($_GET['id']) == 0) {
    ...
    $sql = "SELECT * FROM usuario_usuarios WHERE tipo = 'Cliente' AND id_responsavel = $idAdministrador AND ativo = 0";
    ...
    if (isset($data['excluir']) == 'excluir') {
        ...
        $qAtualizacao->execute(array("Usuário", "Excluir-Cliente", $data['id'], $_SESSION['id'], ".{$_SESSION['id']}.", date('Y-m-d H:i:s')));
...
?>
    ...
    <head>
        <title>Clientes de <?php echo NomeUsuario($idAdministrador); ?></title>
        <!--Ícone-->
                        ...
                        <div class="page-header">
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <div class="page-header-title">
                                        <img src="../../img/usuarios/<?php echo $idAdministrador; ?>.png" class="header-brand-img rounded-circle shadow-lg" alt="lavalite" style="height: 40px; width: 40px;">
                                    </div>
                                </div>
                                <div class="col-lg-8">
                                    <nav class="breadcrumb-container">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active">Clientes de "<?php echo NomeUsuario($idAdministrador); ?>"</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <?php if ($_SESSION['tipo'] == "Administrador Geral") { ?>
                                                            <a title="Editar" href="<?php $_SESSION['Administrador-Cliente'] = $idAdministrador; ?>edit_usuario.php?id=<?php echo $row['id']; ?>" class="btn btn-icon btn-warning mr-1"><i class="ik ik-edit-2"></i></a>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" enctype="multipart/form-data">
                                                <div class="modal-body">
                                                    ...
                                                    <p>Deseja excluir <b><?php echo $row['nome']; ?></b>? As compras deste(a) cliente serão mantidas.</p>
                                                </div>
