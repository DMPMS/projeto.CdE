...
if (isset($_SESSION['id']) == '') {
    ...
    $_SESSION['grafico_novos_usuarios_Clientes'] = [QtdClientesCadastradosNoMes(date('Y-m')), QtdClientesCadastradosNoMes(date('Y-m', strtotime('-1 months'))), QtdClientesCadastradosNoMes(date('Y-m', strtotime('-2 months'))), QtdClientesCadastradosNoMes(date('Y-m', strtotime('-3 months'))), QtdClientesCadastradosNoMes(date('Y-m', strtotime('-4 months'))), QtdClientesCadastradosNoMes(date('Y-m', strtotime('-5 months'))), QtdClientesCadastradosNoMes(date('Y-m', strtotime('-6 months'))), QtdClientesCadastradosNoMes(date('Y-m', strtotime('-7 months'))), QtdClientesCadastradosNoMes(date('Y-m', strtotime('-8 months'))), QtdClientesCadastradosNoMes(date('Y-m', strtotime('-9 months'))), QtdClientesCadastradosNoMes(date('Y-m', strtotime('-10 months'))), QtdClientesCadastradosNoMes(date('Y-m', strtotime('-11 months')))];
    $_SESSION['grafico_novos_usuarios_Administradores'] = [QtdAdministradoresCadastradosNoMes(date('Y-m')), QtdAdministradoresCadastradosNoMes(date('Y-m', strtotime('-1 months'))), QtdAdministradoresCadastradosNoMes(date('Y-m', strtotime('-2 months'))), QtdAdministradoresCadastradosNoMes(date('Y-m', strtotime('-3 months'))), QtdAdministradoresCadastradosNoMes(date('Y-m', strtotime('-4 months'))), QtdAdministradoresCadastradosNoMes(date('Y-m', strtotime('-5 months'))), QtdAdministradoresCadastradosNoMes(date('Y-m', strtotime('-6 months'))), QtdAdministradoresCadastradosNoMes(date('Y-m', strtotime('-7 months'))), QtdAdministradoresCadastradosNoMes(date('Y-m', strtotime('-8 months'))), QtdAdministradoresCadastradosNoMes(date('Y-m', strtotime('-9 months'))), QtdAdministradoresCadastradosNoMes(date('Y-m', strtotime('-10 months'))), QtdAdministradoresCadastradosNoMes(date('Y-m', strtotime('-11 months')))];
?>
                                        ...
                                        <div class="widget-body">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="state">
                                                    ...
                                                    <h2><?php echo QtdAdministradores(); ?></h2>
                                                </div>
                                                <div class="icon">
                            ...
                            <div class="col-lg-12 col-xl-12">
                                <div class="card shadow-lg">
                                    ...
                                    <div class="card-block text-center">
                                        <div id="grafico_novos_usuarios" class="chart-shadow" style="height:400px"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
