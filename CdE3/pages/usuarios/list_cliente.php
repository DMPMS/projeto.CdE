                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <?php if ($_SESSION['tipo'] == "Administrador Geral") { ?>
                                                                <a title="Editar" href="<?php unset($_SESSION['Administrador-Cliente']); ?>edit_usuario.php?id=<?php echo $row['id']; ?>"  class="btn btn-icon btn-warning mr-1"><i class="ik ik-edit-2"></i></a>
