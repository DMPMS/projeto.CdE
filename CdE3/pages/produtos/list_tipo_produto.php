...
if (isset($_SESSION['id']) == '') {
    ...
    if (!isset($_GET['id']) || $_GET['id'] == '' || TipoExiste($_GET['id']) == 0) {
    ...
    $sql = "SELECT * FROM produto_produtos WHERE id_tipo LIKE '%({$idTipo})%' AND ativo = 0";
...
?>
    ...
    <head>
        <title>Produtos de <?php echo NomeTipo($idTipo); ?></title>
        <!--Ícone-->
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <nav class="breadcrumb-container">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active">Produtos de "<?php echo NomeTipo($idTipo); ?>"</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                            ...
                                            <?php foreach ($pdo->query($sql) as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a title="Editar" href="<?php $_SESSION['Tipo-Produto'] = $idTipo; ?>edit_produto.php?id=<?php echo $row['id']; ?>" class="btn btn-icon btn-warning mr-1"><i class="ik ik-edit-2"></i></a>
