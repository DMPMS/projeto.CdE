...
if (@$_SESSION['id'] == '') {
    ...
    <html lang="pt-br">
        <head>
            ...
            <title><?php echo $result['num_venda']; ?>ª Venda Realizada!</title>
            <script>
                function Deslogar(){
                Swal.fire({
                title: '<?php echo $result['num_venda']; ?>ª Venda Realizada!',
                text: 'A venda para <?php echo $result['nome_cliente']; ?> no valor de R$ <?php echo number_format($result['valor'], 2, ',', '.'); ?> foi realizada com sucesso!',
                icon: 'success',
            ...
            <script type='text/JavaScript'>
                setTimeout(function () {
                window.location = 'info_venda.php'; 
                }, 2500); 
            </script>
