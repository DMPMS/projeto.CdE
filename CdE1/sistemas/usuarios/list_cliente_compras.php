...
if (@$_SESSION['id'] == '') {
    ...
    $sql = "SELECT * FROM cde_venda_detalhe WHERE id_cliente = $idCliente";
...
<link rel="icon" type="image/png" href="../../img/ico.png">
            <title>Compras de <?php echo NomeCliente($idCliente); ?></title>
            <script>
                function Deslogar(){
                Swal.fire({
                        ...
                        <div class="container-fluid">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    ...
                                    <a href="cad_venda_produto.php?idCliente=<?php echo $idCliente; ?>" class="btn btn-user btn-info">
                                        <i class="fas fa-plus-circle"></i> Nova Venda
                                    </a>
                                    <h1 class="h2 mb-0 text-gray-800" style="float: right">Compras de <?php echo NomeCliente($idCliente); ?></h1>
                                </div>
                                <div class="card-body">
