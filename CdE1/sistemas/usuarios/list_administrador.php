...
if (@$_SESSION['id'] == '') {
    ...
    $sql = "SELECT * FROM cde_usuario WHERE tipo = 'Administrador'";
                        ...
                        <div class="container-fluid">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    ...
                                    <h1 class="h2 mb-0 text-gray-800" style="float: right">Lista de Administradores</h1>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table class="table table-bordered" id="traduzir" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($pdo->query($sql) as $row) {
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td style="vertical-align:middle"><a href="info_usuario.php?id=<?php echo $row['id']; ?>" style="vertical-align:middle" class="semsublinhar"><button class="btn-sm btn-circle btn-info semborda"><i class="fas fa-info-circle"></i></button></a> <a href="info_usuario.php?id=<?php echo $row['id']; ?>" style="vertical-align:middle" class="semsublinhar"><?php echo $row['nome']; ?></a></td>
                                                        <td style="vertical-align:middle"><?php echo $row['email']; ?></td>
                                                        <td style="vertical-align:middle"><?php echo $row['telefone']; ?></td>
                                                        <td class="text-center" style="vertical-align:middle"><a href="list_cliente_compras.php?idCliente=<?php echo $row['id']; ?>" class="semsublinhar"><button class="btn-sm btn-circle btn-success semborda"> <?php
                                                        ...
                                                        <?php if ($_SESSION['tipo'] == "Administrador Geral") { ?>
                                                            <td class="text-center"><a href="javascript: 
                                                                                       ...
                                                                                       text: 'Se você excluir o cliente, suas vendas também serão excluídas. Os produtos NÃO serão restituídos, e poderá haver descontos nos ganhos mensais, anuais e totais. Selecione Excluir abaixo se você realmente deseja excluir <?php echo $row['nome']; ?>.',
                                                                                       icon: 'question',
                                                                                       showCancelButton: true,
                                                                                       confirmButtonColor: '#d33',
                                                                                       ...
                                                                                       if (result.value) {
                                                                                       window.location = 'del_usuario.php?id=<?php echo $row['id']; ?>';
                                                                                       }
