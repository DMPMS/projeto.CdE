...
if (@$_SESSION['id'] == '') {
    ...
    $sql = "SELECT * FROM cde_produto_tipo";
                        ...
                        <div class="container-fluid">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    ...
                                    <h1 class="h2 mb-0 text-gray-800" style="float: right">Lista de Tipos</h1>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table class="table table-bordered" id="traduzir" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($pdo->query($sql) as $row) {
                                                    ?>
                                                    <tr>
                                                        <td style="vertical-align:middle"><a href="info_tipo.php?id=<?php echo $row['id']; ?>" style="vertical-align:middle" class="semsublinhar"><button class="btn-sm btn-circle btn-info semborda"><i class="fas fa-info-circle"></i></button></a> <a href="info_tipo.php?id=<?php echo $row['id']; ?>" style="vertical-align:middle" class="semsublinhar"><?php echo $row['nome']; ?></a></td>
                                                        <?php if ($_SESSION['tipo'] == "Administrador Geral") { ?>
                                                            <td class="text-center"><a href="javascript: 
                                                                                       Swal.fire({
                                                                                       title: 'Deseja realmente excluir?',
                                                                                       text: 'Selecione Excluir abaixo se você realmente deseja excluir <?php echo $row['nome']; ?>',
                                                                                       icon: 'question',
                                                                                       showCancelButton: true,
                                                                                       confirmButtonColor: '#d33',
                                                                                       ...
                                                                                       if (result.value) {
                                                                                       window.location = 'del_tipo.php?id=<?php echo $row['id']; ?>';
                                                                                       }
