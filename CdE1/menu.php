    ...
    <li class="nav-item">
        ...
        <div id="collapseUsuario" class="collapse" aria-labelledby="headingUsuario" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="sistemas/usuarios/cad_cliente.php">Novo Usuário</a>
                <a class="collapse-item" href="sistemas/usuarios/list_cliente.php">Lista de Clientes</a>
                <a class="collapse-item" href="sistemas/usuarios/list_administradores.php">Lista de Administradores</a>
            </div>
        </div>
    </li>
    <li class="nav-item">
        ...
        <div id="collapseProdutos" class="collapse" aria-labelledby="headingProdutos" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="sistemas/produtos/cad_produto.php">Novo Produto</a>
                <a class="collapse-item" href="sistemas/produtos/list_produto.php">Lista de Produtos</a>
                <a class="collapse-item" href="sistemas/produtos/cad_tipo.php">Novo Tipo</a>
                <a class="collapse-item" href="sistemas/produtos/list_tipo.php">Lista de Tipos</a>
            </div>
        </div>
    </li>
    <li class="nav-item">
        ...
        <div id="collapseVendas" class="collapse" aria-labelledby="headingVendas" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="sistemas/vendas/cad_venda_cliente.php">Nova Venda</a>
                <a class="collapse-item" href="sistemas/vendas/list_venda.php">Lista de Vendas</a>
            </div>
        </div>
    </li>
    <li class="nav-item">
        ...
        <div id="collapseTarefas" class="collapse" aria-labelledby="headingTarefas" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <?php if ($_SESSION['tipo'] == "Administrador Geral") { ?><a class="collapse-item" href="sistemas/tarefas/cad_tarefa.php">Nova Tarefa</a><?php } ?>
                <a class="collapse-item" href="sistemas/tarefas/list_tarefa_pendente.php">Tarefas Pendentes</a>
                <a class="collapse-item" href="sistemas/tarefas/list_tarefa_concluida.php">Tarefas Concluídas</a>
            </div>
        </div>
    </li>
